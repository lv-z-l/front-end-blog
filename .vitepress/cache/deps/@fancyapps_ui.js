// node_modules/.pnpm/registry.npmmirror.com+@fancyapps+ui@5.0.22/node_modules/@fancyapps/ui/dist/index.esm.js
...
Object.defineProperty(f, "version", { enumerable: true, configurable: true, writable: true, value: "5.0.22" }), Object.defineProperty(f, "defaults", { enumerable: true, configurable: true, writable: true, value: {} });
...
var R = class _R extends m {
  ...
  constructor(t2, e2 = {}, i2 = {}) {
    ...
    this.container = t2, this.initContent(), this.attachPlugins(Object.assign(Object.assign({}, _R.Plugins), i2)), this.emit("init");
  ...
  onPointerDown(t2, e2, i2) {
    ...
    if (!i2.length) {
      if (["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO", "IFRAME"].includes(o2.nodeName) || o2.closest("[contenteditable]") || o2.closest("[data-selectable]") || o2.closest("[data-draggable]") || o2.closest("[data-clickable]") || o2.closest("[data-panzoom-change]") || o2.closest("[data-panzoom-action]"))
        return false;
  ...
  updateControls() {
    ...
    f2 && (t(r2) < t(h2) && !this.panOnlyZoomed && (m2 = true), (t(s2.width, 1) > t(s2.fitWidth, 1) || t(s2.height, 1) > t(s2.fitHeight, 1)) && (m2 = true)), t(s2.width * r2, 1) < t(s2.fitWidth, 1) && (m2 = false), n2 === T && (m2 = false);
    let g2 = u2 && t(d2) > t(r2), b2 = !g2 && !m2 && p2 && t(d2) < t(r2);
    o(i2, this.cn("canZoomIn"), g2), o(i2, this.cn("canZoomOut"), b2), o(i2, this.cn("isDraggable"), m2);
...
var Z = class _Z extends m {
  ...
  init() {
    this.state = F.Init, this.emit("init"), this.attachPlugins(Object.assign(Object.assign({}, _Z.Plugins), this.userPlugins)), this.initLayout(), this.initSlides(), this.updateMetrics(), this.setInitialPosition(), this.initPanzoom(), this.attachEvents(), this.state = F.Ready, this.emit("ready");
  }
  initLayout() {
...
var st = class _st extends B {
  ...
  static startFromUrl() {
    if (_st.hasSilentClose = false, _t.getInstance() || false === _t.defaults.Hash)
      return;
...
var lt = { ajax: null, autoSize: true, iframeAttr: { allow: "autoplay; fullscreen", scrolling: "auto" }, preload: true, videoAutoplay: true, videoRatio: 16 / 9, videoTpl: `<video class="fancybox__html5video" playsinline controls controlsList="nodownload" poster="{{poster}}">
...
var ct = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo", "video"];
var ht = class extends B {
  ...
  setAspectRatio(t2) {
    var e2;
    const i2 = t2.width || 0, n2 = t2.height || 0;
    if (i2 && n2)
      return;
    const s2 = t2.contentEl, o2 = this.optionFor(t2, "videoRatio"), a2 = null === (e2 = t2.el) || void 0 === e2 ? void 0 : e2.getBoundingClientRect();
    if (!(s2 && a2 && o2 && 1 !== o2 && t2.type && ["video", "youtube", "vimeo", "html5video"].includes(t2.type)))
      return;
    const r2 = a2.width, l2 = a2.height;
    s2.style.aspectRatio = o2 + "", s2.style.width = r2 / l2 > o2 ? "auto" : "", s2.style.height = r2 / l2 > o2 ? "" : "auto";
  }
  attach() {
    const t2 = this, e2 = t2.instance;
...
var vt = class extends B {
  ...
  build() {
    ...
    S(a2, this.cn("track")), s2.appendChild(a2), this.track = a2, "classic" === n2 ? this.buildClassic() : this.buildModern(), this.state = bt.Ready;
  }
  cleanup() {
...
var yt = Object.assign(Object.assign({}, gt), { key: "t", showOnStart: true, parentEl: null });
var wt = "is-masked";
var xt = "aria-hidden";
...
var Mt = { tabindex: "-1", width: "24", height: "24", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" };
...
var Ot = { Hash: st, Html: ht, Images: at, Slideshow: mt, Thumbs: Et, Toolbar: Tt };
var At = "with-fancybox";
var zt = "hide-scrollbar";
var Lt = "--fancybox-scrollbar-compensate";
var Rt = "--fancybox-body-margin";
var kt = "is-animated";
var It = "is-compact";
var Dt = "is-loading";
var Ft = function() {
...
var _t = class __t extends m {
  ...
  init() {
    if (this.state === et.Destroy)
      return;
    this.state = et.Init, this.attachPlugins(Object.assign(Object.assign({}, __t.Plugins), this.userPlugins)), this.emit("init"), true === this.option("hideScrollbar") && (() => {
      if (!G)
        return;
  ...
  manageCaption(t2 = void 0) {
    ...
    h2 && (h2.innerHTML = "", "string" == typeof c2 ? h2.innerHTML = c2 : c2 instanceof HTMLElement && h2.appendChild(c2));
  }
  checkFocus(t2) {
    var e2;
  ...
  isTopmost() {
    var t2;
    return (null === (t2 = __t.getInstance()) || void 0 === t2 ? void 0 : t2.id) == this.id;
  }
  ...
  static bind(t2, e2, i2) {
    ...
    if (void 0 === t2 ? n2 = document.body : "string" == typeof t2 ? (n2 = document.body, s2 = t2, "object" == typeof e2 && (o2 = e2 || {})) : (n2 = t2, "string" == typeof e2 && (s2 = e2), "object" == typeof i2 && (o2 = i2 || {})), !n2 || !x(n2))
      return;
    s2 = s2 || "[data-fancybox]";
    const a2 = __t.openers.get(n2) || /* @__PURE__ */ new Map();
    a2.set(s2, o2), __t.openers.set(n2, a2), 1 === a2.size && n2.addEventListener("click", __t.fromEvent);
  }
  static unbind(t2, e2) {
    let i2, n2 = "";
    if ("string" == typeof t2 ? (i2 = document.body, n2 = t2) : (i2 = t2, "string" == typeof e2 && (n2 = e2)), !i2)
      return;
    const s2 = __t.openers.get(i2);
    s2 && n2 && s2.delete(n2), n2 && s2 || (__t.openers.delete(i2), i2.removeEventListener("click", __t.fromEvent));
  }
  static destroy() {
    let t2;
    for (; t2 = __t.getInstance(); )
      t2.destroy();
    for (const t3 of __t.openers.keys())
      t3.removeEventListener("click", __t.fromEvent);
    __t.openers = /* @__PURE__ */ new Map();
  }
  static fromEvent(t2) {
    if (t2.defaultPrevented)
      return;
    ...
    if (!(e2 && e2 instanceof Element))
      return;
    let n2, s2, o2, a2;
    if ([...__t.openers].reverse().find(([t3, i3]) => !(!t3.contains(e2) || ![...i3].reverse().find(([i4, r3]) => {
    ...
    if ((!e2 || d2 || c2) && (r2 = [].slice.call(n2.querySelectorAll(s2))), e2 && !c2 && (r2 = d2 ? r2.filter((t3) => t3.getAttribute(`${h2}`) === d2) : [e2]), !r2.length)
      return;
    const p2 = __t.getInstance();
    return p2 && p2.options.triggerEl && r2.indexOf(p2.options.triggerEl) > -1 ? void 0 : (e2 && (l2.startIndex = r2.indexOf(e2)), __t.fromNodes(r2, l2));
  }
  static fromSelector(t2, e2) {
    ...
    if (!s2)
      return false;
    const o2 = s2.get(n2);
    return !!o2 && __t.fromNodes(Array.from(i2.querySelectorAll(n2)), o2);
  }
  ...
  static getSlide() {
    var t2;
    return (null === (t2 = __t.getInstance()) || void 0 === t2 ? void 0 : t2.getSlide()) || null;
  }
  static show(t2 = [], e2 = {}) {
    return new __t(t2, e2);
  }
  static next() {
    const t2 = __t.getInstance();
    t2 && t2.next();
  }
  static prev() {
    const t2 = __t.getInstance();
